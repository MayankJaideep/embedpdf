...
export const Route = createFileRoute("/viewer")({
  head: () => ({
    meta: [
      { title: "EmbedPDF Viewer — Upload, Search & Annotate PDFs" },
      {
        name: "description",
        content:
          "Open a local PDF and view, search and annotate it in the browser with EmbedPDF, with a live performance panel.",
      },
      { property: "og:title", content: "EmbedPDF Viewer — Upload, Search & Annotate PDFs" },
      {
        property: "og:description",
        content: "Frontend-only EmbedPDF viewer with live load, search and annotation timings.",
      },
  ...
  return (
    <div className="flex h-screen flex-col bg-background text-foreground">
      <header className="flex items-center justify-between gap-4 border-b border-border px-5 py-3">
        <div>
          <h1 className="text-base font-semibold tracking-tight">EmbedPDF Viewer</h1>
